    ...
    <div class="container-fluid ms-lg-2 ms-3">
        ...
        <div class="collapse navbar-collapse site-links justify-content-end" id="navLinks">
            <div class="navbar-nav align-items-lg-end">
                ...
                <a class="btn btn-light btn-sm ms-2 my-1" href="<%= request.getContextPath() %>/portal/trainers">Trainers</a>
...
<main class="container my-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-4">
            <div class="card panel shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<%= request.getContextPath() %>/portal/trainers">
                        ...
                        <div class="mb-3">
                            <label for="mobile" class="form-label fw-semibold">Phone Number</label>
                            <input type="text" id="mobile" name="mobile" class="form-control" placeholder="Example: 0771234567" required>
                        </div>
        ...
        <div class="col-12 col-lg-8">
            <div class="card panel shadow-sm border-0">
                <div class="card-header bg-light">
                    <h5 class="mb-0">Registered Trainers</h5>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover align-middle mb-0">
                            ...
                            <% } else { %>
                            <tr>
                                <td colspan="5" class="text-center py-3">No trainers are registered.</td>
                            </tr>
                            <% } %>
                            </tbody>
                        </table>
